import { TinyColor } from 'https://cdn.skypack.dev/@ctrl/tinycolor';
...
class GradientBG {
    ...
    generate() {
        ...
        let secondaryCombinations = new TinyColor(secondaryColor).splitcomplement();
