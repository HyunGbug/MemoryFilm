//게시물 댓글 클릭 시 스크롤 위치 저장 및 페이지 이동
function saveScrollPositionAndViewPost(postNo) {
    localStorage.setItem('scrollPosition', window.scrollY);
    window.location.href = contextPath + '/view.post?postNo=' + postNo + '&showComments=true';
}
...
// 게시물 클릭 시 스크롤 위치 저장 및 페이지 이동
function viewPost(postNo) {
	localStorage.setItem('scrollPosition', window.scrollY);
	window.location.href = contextPath + '/view.post?postNo=' + postNo;
}
