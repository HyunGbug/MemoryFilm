...
<title>Memory Film :: Edit Post</title>
<!-- 부트스트랩 -->
...
<body>
	...
	<main>
		<div class="post-container">
			<form action="${pageContext.request.contextPath}/update.post" method="post">
				...
				<div class="post">
					...
					<div class="post-footer d-flex justify-content-between align-items-center">
						...
						<button type="button" class="btn btn-secondary"
							onclick="location.href='${pageContext.request.contextPath}/view.post?postNo=${post.no}'">취소</button>
					</div>
				</div>
			</form>
		</div>
